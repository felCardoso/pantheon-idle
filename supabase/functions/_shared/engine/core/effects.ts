...
import { teamContextFor } from './context.ts';
import { resolveTargets } from './targeting.ts';
import { resolveMagnitude } from './magnitude.ts';
import { absorbIntoShield, applyStatus, dispelStatuses, effectiveDef } from './statusEffects.ts';
