...
import { atLevel, passiveAbilityFor, resolveCombatantBaseStats, resolvePassiveUnlock, synergyBonusFor } from '../core/loader.ts';
import { NO_MODULE_BONUSES, type ModuleBonuses } from '../core/modules.ts';
import type { WorldId } from '../core/progression.ts';
import { ALL_CHARACTER_DATA, TURN_ABILITIES, TURN_CHARACTER_KITS, WORLD_ENEMIES } from '../data/index.ts';
import type { TurnOwnedCharacterEntry } from './schema.ts';
import type { Row, TurnCombatant } from './types.ts';
