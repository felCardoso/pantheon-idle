...
import { checkVictory, decideByRemainingHp } from '../core/battle';
import { resolveAttack } from '../core/damage';
import { Rng, type RngLike } from '../core/rng';
import { absorbIntoShield, dispelStatuses, effectiveIce } from '../core/statusEffects';
import {
  activateAbility,
  fireAbility,
  fireDeath,
...
import type { TurnAction, TurnBattleLogEntry, TurnCombatant, TurnPhase } from './types';
