...
export function Modal({ title, icon, onClose, children }: ModalProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-6">
      ...
      <div className="relative flex h-full max-h-[42rem] w-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-code-500/25 bg-void-900 shadow-[0_0_60px_-10px_rgba(57,255,156,0.25)]">
